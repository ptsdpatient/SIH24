...
<body class="bg-gray-80 flex items-center justify-center min-h-screen">

  <!-- Container -->
  <div class="bg-white p-8 rounded-lg shadow-lg max-w-md w-full">
    <!-- Logo -->
    <div class="flex justify-center mb-6">
      <img src="logo.png" alt="Gradsy Logo" class="h-16">
    </div>
    ...
    <div class="flex justify-center mt-4 space-x-4">
      <a href="#" class="bg-white border p-2 rounded-lg hover:bg-gray-100 flex items-center">
        <img src="google.png" alt="Google" class="h-6 w-6">
      </a>
      <a href="#" class="bg-white border p-2 rounded-lg hover:bg-gray-100 flex items-center">
        <img src="github-icon.png" alt="GitHub" class="h-6 w-6">
      </a>
      <a href="#" class="bg-white border p-2 rounded-lg hover:bg-gray-100 flex items-center">
        <img src="linkedin-icon.png" alt="LinkedIn" class="h-6 w-6">
      </a>
    </div>
  </div>
