        ...
        <div class="bg-white bg-opacity-30 backdrop-blur rounded-lg shadow-lg p-6 max-w-md w-full animate-fadeIn">
            ...
            <div action="" class="mt-4">
                ...
                <div class="w-2/3 mx-auto flex flex-wrap justify-between">
                  ...
                  <button class="w-1/2 flex flex-row justify p-2.5 mb-4 border-none rounded-lg text-lg bg-gray-200 flex items-center justify-center">
                    <img class="w-1/4 ml-2" src="/icon/google.png" alt=""> Google
                  </button>
